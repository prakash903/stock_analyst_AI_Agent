...
# ==========================================
# 1. Initialize Cloud LLM (Bypassing OpenAI Bug)
# ==========================================
# We feed CrewAI a fake OpenAI key to stop it from crashing on boot, 
# and then provide the real Groq key for the actual work.
